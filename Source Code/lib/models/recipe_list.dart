...
import 'package:cookipidia/components/custom_dropdown.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../network/model_response.dart';
import '../../network/recipe_model.dart';
import '../../network/recipe_service.dart';
import 'package:cookipidia/components/recipe_card.dart';
import 'package:cookipidia/components/colors.dart';

import 'package:cookipidia/models/models.dart';
import 'package:cookipidia/models/recipe_details.dart';
...
class _RecipeListState extends State<RecipeList> {
  ...
  Widget build(BuildContext context) {
    // final mode = Provider.of<ProfileManager>(context).darkMode;
    return Container(
      child: Padding(
